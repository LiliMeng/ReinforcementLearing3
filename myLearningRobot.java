...
import robocode.AdvancedRobot;   
    ...
    public class myLearningRobot extends AdvancedRobot   
    {   
      ...
      {   
        saveData();   
		 ...
		 PrintStream w = null; 
		    try 
		    { 
		      w = new PrintStream(new RobocodeFileOutputStream("/home/lili/workspace/EECE592/RL/src/survival.xlsx", true)); 
